...
HELP_TEXTS = {
    "configuration.prefixes": (
        ...
        " [See the FAQ](/documentation?section=what-are-prefixes)."
    ),
    "configuration.data_bundles": (
        ...
        " [Learn more](/documentation?section=what-are-data-bundles)."
    ),
    "configuration.import_data": (
        "Import N-Quads or Turtle files directly into the selected graph."
        " [How to import data?](/documentation?section=how-to-import-data-into-the-sparql-endpoint)."
    ),
    "configuration.update_model": (
        "Download, clear or upload your SHACL model from this block."
        " [What are SHACL models?](/documentation?section=what-are-shacl)."
    ),
    ...
    "data_table.overview": (
        ...
        " [How to see my data?](/documentation?section=how-to-see-my-data)."
    ),
    ...
    "dashboard.export": ("Jump to the filterable table to prepare a targeted export."),
    ...
    "menu.create_entity": (
        ...
        " [How to create new data?](/documentation?section=how-to-create-new-data)."
    ),
    "find_entity.label": (
    ...
    "sparql_editor.saved_query": (
        ...
        " [Can I save a specific query?](/documentation?section=can-i-save-a-specific-query)."
    ),
    "entity_card.raw_triples": (
        "Show the raw triples related to the entity to inspect the stored data."
        " [What is the page Raw triples for?](/documentation?section=what-is-the-page-raw-triples-for)."
    ),
    "entity_card.visualize": (
        "Open the graph view to navigate through related entities."
        " [What is shown on page Visualization?](/documentation?section=what-is-shown-on-page-visualization)."
    ),
    "entity_chart.entity_card": ("Return to the detailed entity card."),
    "entity_chart.raw_triples": ("Display the raw triples for the current entity."),
    ...
    "data_bundle_form.endpoint_technology": (
        ...
        " [Supported technologies](/documentation?section=what-are-the-supported-sparql-endpoint-technologies)."
    ),
    ...
    "data_bundle_form.endpoint_username": (
        ...
        " [Where do I find credentials?](/documentation?section=in-the-data-bundle-creation-where-do-i-find-my-sparql-endpoint-username-and-password)."
    ),
    ...
    "data_bundle_form.data": (
        ...
        " [Why three graphs?](/documentation?section=in-the-data-bundle-creation-why-should-i-provide-3-graphs-uris-data-model-metadata)."
    ),
    "data_bundle_form.graph_model": ("URI of the graph that stores your SHACL/model."),
    ...
    "data_bundle_form.model_framework": (
        ...
        " [Supported frameworks](/documentation?section=what-are-the-supported-model-framework-supported)."
    ),
    ...
    "data_bundle_form.comment_property": ("Property used for descriptions/comments."),
}
